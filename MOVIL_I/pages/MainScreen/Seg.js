...
const Seg = (props) => {
  ...
  const menuItems = [
    //{ title: 'Cafes', icon: faMugSaucer, },
    { title: 'Plazas', icon: faWhiskeyGlass, },
    //{ title: 'Compras', icon: faCartShopping, },
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        try {
          //Recuperar coordenadas de ubicacion actual
  ...
  return (
    <View style={MainScreenStyles.mainContainer}>
      ...
      <FooterBasic onSearch={handleSearch} />
    </View>
