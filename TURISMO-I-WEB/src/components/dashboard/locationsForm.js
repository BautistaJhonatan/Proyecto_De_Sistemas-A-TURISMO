...
export default function LocationsForm({ location, user, setCurrentContent, categories, setCurrentLocation  }) { 
    ...
    const formik = useFormik({
      ...
      return (
          <form onSubmit={formik.handleSubmit} className="locations-form rounded-lg">
            ...
            <input className="w-full p-2 border " type="text" name="name" placeholder="Nombre" onChange={formik.handleChange} value={formik.values.name} />
            <input className="w-full p-2 border border-main-text-color" type="text" name="address" placeholder="Direccion" onChange={formik.handleChange} value={formik.values.address} />
                <select className="w-full rounded p-2 " name="category_id" onChange={formik.handleChange} value={formik.values.category_id}>    
